  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-12" id="contact">
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <h2 className="text-4xl sm:text-5xl Myanmar Khyay mb-4">Get In Touch</h2>
          <p className="text-gray-600 text-[16px] Montserrat mb-8">
          ...
          <div className="mb-6">
            <div className="flex items-center mb-2">
              ...
              <p className="text-[17px] Myanmar Khyay">OFFICE</p>
            </div>
            <p className="text-gray-700 text-[15px] Montserrat ml-9">
          ...
          <div>
            <div className="flex items-center mb-2">
              <span className="text-blue-600 text-2xl mr-3">💬</span>
              <p className="text-[17px] Myanmar Khyay">GET IN TOUCH</p>
            </div>
            <p className="ml-9 text-gray-700 text-[15px] Montserrat">+91 97957 20319</p>
            <p className="ml-9 text-gray-700 text-[15px] Montserrat">Example@123.gmail.com</p>
          </div>
        </div>
